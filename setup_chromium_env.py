...
This script prepares the environment to run graphite_ganesh_runbenchmark.py by:
...
def install_python_deps():
    """Install Python packages needed by graphite_ganesh_runbenchmark.py."""
    print('\n' + '=' * 60)
...
def verify_setup(chromium_dir):
    """Verify that the environment is ready for graphite_ganesh_runbenchmark.py."""
    print('\n' + '=' * 60)
    ...
    checks = [
        ...
        ('graphiteperf/graphite_ganesh_runbenchmark.py', os.path.exists(
            os.path.join(src_dir, 'graphiteperf', 'graphite_ganesh_runbenchmark.py'))),
    ]
    ...
    if all_ok:
        ...
        print(f'\nTo run benchmarks:')
        print(f'  cd {src_dir}')
        print(f'  python graphiteperf\\graphite_ganesh_runbenchmark.py init')
        print(f'  python graphiteperf\\graphite_ganesh_runbenchmark.py run --story=<story_name>')
    else:
...
def main():
    ...
    print('=' * 60)
    print('Chromium Environment Setup for graphite_ganesh_runbenchmark.py')
    print('=' * 60)
